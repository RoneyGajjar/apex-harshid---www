...
//   title: "About Apex Harshid | 40+ Years of Excellence",
//   description:
//     "Learn about Apex Harshid’s legacy, commitment to quality, and customized valve solutions for industries worldwide, backed by over 40 years of expertise.",
        ...
        <div className="py-20">
          <HeadlineV1
            ...
            title={
              <>
                ABOUT US — <br />
                <span className="text-[var(--primary-color)]">Apex</span>{" "}
                Harshid.
              </>
            }
            desc={
